...
public class Exercise {
    ...
    public Exercise(String exName, String muscle, String description,
                    String tutorialLink, int targetSets, int targetReps, int targetWeight) {
        this.exName = exName;
        this.muscle = muscle;
    ...
    public String getTutorialLink() { return tutorialLink; }
    ...
    public void setExName(String exName) { this.exName = exName; }
    public void setMuscle(String muscle) { this.muscle = muscle; }
    public void setDescription(String description) { this.description = description; }
    public void setTutorialLink(String tutorialLink) { this.tutorialLink = tutorialLink; }
